...
\begin{solutionblock}
	Since $i_\mathrm{m}(t)$ should not increase after a switching period, the applicable duty cycle
	is limited to less than or equal to $0.5$. From \eqref{eq:ex04voltageratioforwardconverter} follows that at minimum input voltage
	the duty cycle is maximum. Using \eqref{eq:ex04voltageratioforwardconverter} leads to
	\begin{equation}
...
\begin{solutionblock}
	...
	\begin{equation}
		\Delta i_\mathrm{2}= \frac{D \cdot U_\mathrm{2}}{L_\mathrm{m} \cdot f_\mathrm{s}} = 0.1 \cdot \overline{i}_\mathrm{2}.
	\end{equation}
	Using the result of \eqref{eq:ex04averageoutputcurrent} this leads to
	\begin{equation}
		L_\mathrm{m}  = \frac{D \cdot U_\mathrm{2}}{0.1 \cdot \overline{i}_\mathrm{2} \cdot f_\mathrm{s}}
...
The output inductance $L$ is dimensioned so that the current $i_\mathrm{L}$ exhibits a continuous curve shape.
...
\begin{solutionblock}
	...
	\begin{equation}
		I_\mathrm{2p}'=I_\mathrm{2}\frac{N_\mathrm{2}}{N_\mathrm{1}}.
	\end{equation}
	This leads to the current $\hat{i}_\mathrm{m}$ of
	\begin{equation}
		\hat{i}_\mathrm{m}=I_\mathrm{2p}'\cdot 0.1=I_\mathrm{2}\frac{N_\mathrm{2}}{N_\mathrm{1}}\cdot 0.1
...
\begin{solutionblock}
	The current through the primary coil $N_\mathrm{1}$ is still calculated with \eqref{eq:ex04magnetizationcurrent} and yields
	$\SI{0.1344}{\ampere}$.
