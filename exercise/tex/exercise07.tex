...
% Subtask5
\subtask{Mark the input current $i_\mathrm{1}(t)$ of the AC-DC converter in the same figure of subtask 7.1.4.}
\begin{solutionblock}
...
\begin{solutionblock}
    ...
    \input{fig/ex07/sFig_Voltage_u2ab_u2bc_u2a_um0}
...
\begin{solutionblock}
    ...
    \input{fig/ex07/sFig_Voltage_u2a0_excerpt}   
    \begin{equation}
        \begin{split}
    ...
    \input{fig/ex07/sFig_graphic_solutions_cos_terms}
