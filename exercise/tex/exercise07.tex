...
\begin{table}[ht]
    ...
    \begin{tabular}{ll}
        ...
        Internal load voltage: & $u(t) = 150 \sin(\omega t - \frac{\pi}{6})$ \\ 
...
\end{table}
The inverter is modulated using PWM with a modulation of M=0.75.  Assuming ideal operation of the switching components:
% Subtask1
...
One square corresponds to a voltage time area of $\SI{17.8}{\milli \volt \second}$. The starting point is marked with AP.\\
