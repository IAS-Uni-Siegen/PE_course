...
\figCircuitWithOneTransistorAndOneLoadResistor
...
\sfigDisplayOfCurrentsAndVoltagesDependingOnTheSwitchingPhases
...
\sfigInstantaneousPowerAtTheLoadResistor
...
\figStepDownConverterOutputFilter
...
\sfigSwitchingStatesStepDownConverter
...
\sfigRelevantVoltageAndCurrentSignals
...
The BCM operation is characterized by zero inductor current events at the beginning / end of a switching period, compare \autoref{fig:BCM_step-down-converter}.
    ...
    \sfigQualitativeInductorCurrentDuringBCM
...
\figBuckConverterWithOneTransistorAndOneDiode
...
\figSwitchOnBehaviorAndSwitchOffBehaviorOfUI
...
Finally, \autoref{fig:Power values for the switch-off process} results from these power values. The switch-off losses of the IGBT are calculated next. For this purpose, the power curve is divided into three parts:
    ...
    \sfigSwitchOnBehaviorAndSwitchOffBehaviorOfPower
