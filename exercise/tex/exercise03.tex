...
\subtask{Plot $D$ and the voltage $U_\mathrm{0}$ against $U_\mathrm{2}$ and calculate the numerical values for $U_\mathrm{2}$ = 285V, $U_\mathrm{2}$ =
...
\subtask{Write the formula for the dependence of the input and output inductance ripple $\Delta i_\mathrm{L1}$ and $\Delta i_\mathrm{L2}$ from the duty cycle.}
