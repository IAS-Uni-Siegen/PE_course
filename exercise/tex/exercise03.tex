...
\begin{solutionblock}
    ...
    \begin{align}
        ...
        &= \left[\frac{0.4^2}{\left(1-0.4\right)^2} \cdot \left(\SI{1.25}{\ampere}\right)^2 + \frac{1}{12}\cdot \left(\SI{4.16}{\ampere}\right)^2 \right] \cdot \SI{30}{\micro\second} = \SI{64.1}{\micro\ampere\per\second}.
        \end{split}
    \end{align}
    The calculation of the second part (transistor is open) is given by:
    \begin{equation}
        \int_{T_{\mathrm{off}}}^{T_{\mathrm{s}}} \left(-I_2 \right)^2 \mathrm{d}t = \left[I_2^2 t \right]_{T_{\mathrm{off}}}^{T_{\mathrm{s}}} = I_2 \left(T_{\mathrm{s}} - T_{\mathrm{off}}\right) = \SI{1.25}{\ampere} \cdot (\SI{50}{\micro\second} - \SI{30}{\micro\second}) = \SI{31.3}{\micro\ampere\per\second}.
    \end{equation}
    Hence, the capacitor RMS current is calculated with:
    \begin{equation}
        i_{\mathrm{C,RMS}} = \sqrt{\frac{1}{\SI{50}{\micro\second}} \left(\SI{64.1}{\micro\ampere\per\second} + \SI{31.3}{\micro\ampere\per\second}\right)} = \SI{1.38}{\ampere}.
    \end{equation}
