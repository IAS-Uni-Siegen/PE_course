...
\begin{solutionfigure}[htb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=blue,mark=none,solid] coordinates{
                ...
                \node[blue, fill=white, inner sep = 1pt, anchor = south] at (axis cs:0.15,400) {$U_{\mathrm{1}=\SI{360}{\volt}}$};                    
            %UT at U1=240V
            \addplot[color=black,mark=none,solid] coordinates{
                ...
                \node[black, fill=white, inner sep = 1pt, anchor = south] at (axis cs:0.51,200) {$U_{\mathrm{1}=\SI{240}{\volt}}$};                    
            \end{axis}     
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \node[red, fill=white, inner sep = 1pt, anchor = south] at (axis cs:0.15,400) {$U_{\mathrm{1}=\SI{360}{\volt}}$};                    
            %im at U1=240V
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \node[red, fill=white, inner sep = 1pt, anchor = south] at (axis cs:0.15,10) {$U_{\mathrm{1}=\SI{360}{\volt}}$};                    
            %im at U1=240V
            ...
            \node[black, fill=white, inner sep = 1pt, anchor = south] at (axis cs:0.5,10) {$U_{\mathrm{1}=\SI{240}{\volt}}$};                    
            \end{axis}     
    \end{tikzpicture}
