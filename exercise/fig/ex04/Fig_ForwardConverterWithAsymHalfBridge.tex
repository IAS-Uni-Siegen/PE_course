    ...
    \begin{center}
        \begin{circuitikz}[european currents,european resistors,american inductors]
            \draw 
                    ...
                    (jD2a) ++(1,0)  coordinate  (jLtpcv)
                    % Add connection point for transformer Ltpcg
                    (jT2c) ++(1,0)  coordinate  (jLtpcg)
                    % Add connection to half bridge 1
                    (jLtpcv) to [short,-*] (jT1e)
                    % Add connection to tranformator jLtpv
                    (jLtpcv) to [short,-] ++(0,1.5)  coordinate  (jLtpchv)
                    (jLtpchv) to [short,-] ++(1,0)  coordinate  (jLtpv)
                    % Add connection to half bridge 2
                    (jLtpcg) to [short,-*] (jT2c)
                    % Add connection to tranformator jLtpg
                    (jLtpcg) to [short,-] ++(0,-1.5)  coordinate  (jLtpchg)
                    (jLtpchg) to [short,-] ++(1,0)  coordinate  (jLtpg)
                    % Add arrow and Text
            ...
            \draw 
                    ...
                    (jLtsv) to [L,n=Lts,v^=$U_\text{s}$, voltage shift=0.5, voltage=straight] ++(0,-4) coordinate (jLtsg)
                    % Add winding text
                    (jLtsg) node[above right] {$N_\mathrm{2}$};     
