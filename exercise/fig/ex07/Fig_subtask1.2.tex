...
\begin{figure}[h!]
    ...
    %   \pgfplotsset{compat=1.18} % Kompatibilität für neuere Versionen
        ...
        \addplot[red, domain= 0:360, solid] {150*sin(x)};
         % Label of u^(1)_2
         \node[red, fill=white, inner sep = 1pt, anchor = south] at (axis cs:70,155) {$u^\mathrm{(1)}_\mathrm{2}(t)$};
        \end{solutionblock}
           \end{axis}
           \begin{axis}[
            % x/y range adjustment
        ...
        \begin{solutionblock}
              ...
              \addplot[green, domain= 0:360, solid] {51.5*sin(x-14.9)};
                % Label of i^(1)_2
                \node[green, fill=white, inner sep = 1pt, anchor = south] at (axis cs:100,25) {$i^\mathrm{(1)}_\mathrm{2}(t)$};
            \end{solutionblock}
           \end{axis}             
           \end{tikzpicture}
