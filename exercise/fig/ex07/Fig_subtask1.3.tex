...
\begin{figure}[h!]
    ...
    %   \pgfplotsset{compat=1.18} % Kompatibilität für neuere Versionen
        ...
        % plot of u^(1)_2
        \addplot[blue, domain= 0:360, solid] {-150*sin(x)+200};
        \addplot[blue, domain= 0:360, solid] {-150*sin(x)-200};
       
        \begin{solutionblock}
         % Label of u^(k)_2
         \node[black, fill=white, inner sep = 1pt, anchor = south] at (axis cs:25,210) {$u^\mathrm{(k)}_\mathrm{2}(t)$};
        % plot of u^(k)_2
    ...
    \end{solutionblock}
        ...
        \begin{solutionblock}
            ...
            %\addplot[red, thick, domain= 0:46, solid] {80*sin(x)-50};
            ...
            % Label of i^(k)_2
            \node[red, fill=white, inner sep = 1pt, anchor = south] at (axis cs:280,30) {$i^\mathrm{(k)}_\mathrm{2}(t)$};
            %\draw[thick, red, solid] (90,-22.05) ;
        \end{solutionblock}
           \end{axis}             
           \end{tikzpicture}
