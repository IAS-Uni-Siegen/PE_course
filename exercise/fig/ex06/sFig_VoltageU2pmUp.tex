...
\begin{solutionfigure}[htb]
 ...
 %   \pgfplotsset{compat=1.18} % Kompatibilität für neuere Versionen
        ...
        \begin{tikzpicture}
            ...
            \addplot[blue, domain= 90:210] {325*cos(x-120)};                
           ...
           \addplot[blue,domain= 0:360,dashed, name path = u2pavg] {233}; 
            ...
            % Voltage u2m(wt)
            \addplot[blue, domain= 0:30] {325*cos(x-120)};                
            \addplot[blue, domain= 30:150] {325*cos(x-240)};                
            \addplot[blue, domain= 150:270] {325*cos(x)};                
            \addplot[blue, domain= 270:360] {325*cos(x-120)};
            \addplot[color=blue,solid] coordinates{
                (30,0)
                (30, -281.4)
            };     
            ...
            % Label of T1
            \draw[<-,black, solid, thin] (axis cs:330,460) -- (axis cs:360,460);
            \draw[->,black, solid, thin] (axis cs:0,460) -- (axis cs:90,460);
            \node[black, fill=white, inner sep = 1pt, anchor = south] at (axis cs:12,400) {$\mathrm{T_1}$};
            % Label of T3
            \draw[<->,black, solid, thin] (axis cs:90,460) -- (axis cs:210,460);
            \node[black, fill=white, inner sep = 1pt, anchor = south] at (axis cs:140,400) {$\mathrm{T_3}$};
            % Label of T5
            \draw[<->,black, solid, thin] (axis cs:210,460) -- (axis cs:330,460);
            \node[black, fill=white, inner sep = 1pt, anchor = south] at (axis cs:280,400) {$\mathrm{T5}$};

            % Thyristor phases u2m
            % Label of T2
            \draw[<->,black, solid, thin] (axis cs:30,-440) -- (axis cs:150,-440);
            \node[black, fill=white, inner sep = 1pt, anchor = south] at (axis cs:90,-500) {$\mathrm{T_2}$};
            % Label of T4
            \draw[<->,black, solid, thin] (axis cs:150,-440) -- (axis cs:270,-440);
            \node[black, fill=white, inner sep = 1pt, anchor = south] at (axis cs:200,-500) {$\mathrm{T_4}$};
            % Label of T6
            \draw[<-,black, solid, thin] (axis cs:270,-440) -- (axis cs:360,-440);
            \draw[->,black, solid, thin] (axis cs:0,-440) -- (axis cs:30,-440);
            \node[black, fill=white, inner sep = 1pt, anchor = south] at (axis cs:330,-500) {$\mathrm{T_6}$};
