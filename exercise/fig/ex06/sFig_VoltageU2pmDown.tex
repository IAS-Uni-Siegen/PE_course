...
\begin{solutionfigure}[htb]
 ...
 %   \pgfplotsset{compat=1.18} % Kompatibilität für neuere Versionen
        ...
        \begin{tikzpicture}
            ...
            \addplot[blue, domain= 150:270] {325*cos(x+120)};
        ...
        \end{axis}     
        \end{tikzpicture}
        \caption{Output voltage $u_\mathrm{2,p}(t)$ and $u_\mathrm{2,m}(t)$ for lowing load.}
