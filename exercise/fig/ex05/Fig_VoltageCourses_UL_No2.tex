\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            xlabel={$t / \mathrm{ms}$},
            ylabel={$u_\mathrm{1}(t) / u_\mathrm{L}(t) / \overline u_\mathrm{L}(t) / \mathrm{V}$},
            axis lines=left,
            ymin=-400, ymax=400,
            xmin=0, xmax=10,
    ...
    \caption{Voltage curve $u_\mathrm{L}$ and local average of $\overline u_\mathrm{L}$ with signal for power transistor T.}
