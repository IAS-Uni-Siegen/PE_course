...
\subtaskGerman{Ergänzen Sie in \autoref{fig:subtask4.1_time} qualitativ die Größen $u^\mathrm{(1)}_\mathrm{2}(t)$,
	...
	\end{itemize}}
\input{fig/Task04/Subtask4.1_time_plots}
\begin{solutionblock}
	...
	\input{fig/Task04/sFig_subtask4.1_time_plots}
\end{solutionblock}
...
\input{fig/Task04/Subtask4.1_phasor_diagrams}

\begin{solutionblock}
	The solution is shown in \autoref{sfig:sfig:subtask4.1_phasors}.
	\input{fig/Task04/sFig_subtask4.1_phasor_diagrams}
\end{solutionblock}
