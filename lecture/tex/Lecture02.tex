    ...
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \begin{itemize}
                ...
                \item No discontinuous current flow (\hl{no DCM mode}).
                \item Transistors must be \hl{switched complementary} to prevent a \hl{DC-link short-circuit}: 
                \begin{itemize}
                    \item $T_1$: on, $T_2$: off,
                    \item $T_1$: off, $T_2$: on.
                \end{itemize}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \begin{circuitikz}[]
                    \draw (0,4) coordinate (A) to [open, o-o, v = $u_1(t)\hspace{0.5cm}$, voltage = straight] ++(0,-4) coordinate (B)
    ...
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \begin{itemize}
                ...
                \end{itemize}
                \item Possible switching states:
            \end{itemize}
        \begin{center}
    ...
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \begin{itemize}
                ...
                \item Also requires complementary switching of $\{T_1, T_2\}$ and $\{T_3, T_4\}$ to prevent a DC-link short-circuit. 
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            \item Also holds 2Q converter from \figref{fig:DCDC-switch-two-voltage-polarities}.
            \item Boost mode follows from flipping input and output.
        \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{figure}
