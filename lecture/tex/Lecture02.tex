        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \begin{tikzpicture}
                    ...
                    \begin{groupplot}[group style={group size=1 by 2, xticklabels at = edge bottom}, height=0.34\textheight, width=0.8\textwidth, xmin=-0.1, xmax=1.1, grid,clip = false, ymin = 0, ymax =1.1]
                        ...
                        \nextgroupplot[ylabel = {$i_\mathrm{c}(t)$}, xlabel={$t/T_\mathrm{s}$}, ymin=-0.3, ymax=0.3, ytick = {-0.2, 0, 0.2}, yticklabels = {$\nicefrac{-\Delta i_\mathrm{L}}{2}$, 0,$\nicefrac{\Delta i_\mathrm{L}}{2}$}]
                            ...
                            \draw [thick,<->]  (\Ton -\Ton/2,0.4) -- node[above]{$\nicefrac{T_\mathrm{s}}{2}$}(\Ton +\Toff/2, 0.4);
