...
\begin{frame}[b]
    ...
    \begin{figure}
        \begin{itemize}
            \item Polarity change of the inductor can be also achieved by a \hl{single switch} which input is connected to the inductor.
            \item Assuming an ideal, infinitely fast switch, the inductor current $i_\mathrm{L}(t)$ remains well-defined (no open switch inductor scenario).
        \end{itemize}
        \begin{circuitikz}[]
