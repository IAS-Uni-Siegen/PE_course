...
\begin{frame}
   ...
   Inserting the B2U ideal input voltage assumption $u(t)=u_1(t)=\hat{u}_1\sin(\omega t)$, this boils down to:
    ...
    \end{equation}
    i.e., the harmonics increase the apparent power $S$ but do not contribute to the active power $P$. Consequently, the B2U's power factor is typically limited to $60\,\%$ or lower.    
\end{frame}
