...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Characteristic PFC signals in the time domain (quasi steady state) %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
    \frametitle{Characteristic PFC rectifer signals in the time domain (quasi steady state)} 
    \begin{figure}
        \begin{tikzpicture}
...
\begin{frame}
    ...
    \end{itemize}
    Due to its simplicity and low component count, the \hl{boost converter is the most common choice for PFC} applications leading to the reference duty cycle:
    \begin{equation}
