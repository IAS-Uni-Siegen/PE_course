...
\begin{frame}
	...
	\begin{itemize}
		...
		\item<5-> However, the transformer's primary magnetizing inductance is a function of the primrary turns number, i.e.,  $L_\mathrm{m}=L_\mathrm{m}(N_1)$ (cf. \href{https://github.com/IAS-Uni-Siegen/EMD_course}{Electrical Machines and Drives} course material).
	\end{itemize}
\end{frame}
