...
np.savetxt(save_path, np.column_stack((x[idx_sum], s_tri[idx_sum], d_lin_sample[idx_sum], c_tri_sample[idx_sum])), delimiter=',', header='wt, s, d, c', comments='')
...
np.savetxt(save_path, np.column_stack((x[idx_sum], s_saw[idx_sum], d_lin_sample[idx_sum], c_saw_sample[idx_sum])), delimiter=',', header='wt, s, d, c', comments='')
